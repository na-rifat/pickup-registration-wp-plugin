    ...
    public function register_pickup()
    {
        ...
        $result = $wpdb->insert(
            ...
            [
                ...
                'request-date' => pr_var('request-date'),
        ...
        update_user_meta($user, 'organization', pr_var('organization'));
        ...
        if ($updated) {
            // wp_send_json_success(['msg' => __('Pickup registration successfull.'), 'test' => $updated]);
